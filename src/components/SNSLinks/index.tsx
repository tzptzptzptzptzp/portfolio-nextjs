import styles from 'src/components/SNSLinks/SNSLinks.module.css'

export function SNSLinks() {
    return (
        <>
            <div className={styles.snsLink}>
                <a href="https://twitter.com/tzptzptzptzptzp">
                ...
                <a href="https://www.instagram.com/tzptzptzptzptzp/?hl=ja">
